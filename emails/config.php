...
define('CONTACTFORM_FROM_ADDRESS', 'kingjd2485@gmail.com.com');
define('CONTACTFORM_FROM_NAME', 'contact form');
...
define('CONTACTFORM_TO_ADDRESS', 'shriyashjadhav007@gmail.com');
define('CONTACTFORM_TO_NAME', 'shree');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'kingjd2485@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'egtoxumgrlsdakvd');
